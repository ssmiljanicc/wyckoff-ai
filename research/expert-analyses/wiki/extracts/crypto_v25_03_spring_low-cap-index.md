...
asset: Low Cap Crypto Index
timeframe: 4-hour
wyckoff_event: spring
structure: trading-range
phase: C
image_path: raw/crypto_archive/images/wyckoff-crypto-report-vol-25/03-Low-Cap-Crypto-Index-8bc364c5.png
type: forward
status: candidate
---
...
4-hour Low Cap Crypto Index chart prati trading range od apsorpcije do shakeout-a sa successful test-om. Autor izričito kaže da je time Phase C završena pre početka uptrend-a.
