---
source: raw/book/pages/page_151.md
page: 151
asset: unknown
timeframe: unknown
wyckoff_event: upthrust-after-distribution
related_events: last-point-of-supply
structure: distribution
phase: unknown
image_path: raw/book/images/page_151_fig_1.png
type: schematic
status: candidate
---
...
`page_151_fig_1.png` prikazuje minor UTAD na lokalnim highs unutar
distribution range-a. Pasus ga tumači kao znak većeg seller control-a i
eksplicitno navodi LPSY kao alternativnu metodološku oznaku istog događaja.

## Napomene

`last-point-of-supply` je dodat samo kao eksplicitna alternativna klasifikacija
istog prikaza; `phase` nije navedena na primary raw strani.
