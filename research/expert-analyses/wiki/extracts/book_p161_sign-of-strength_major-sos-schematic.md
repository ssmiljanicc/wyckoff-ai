---
source: raw/book/pages/page_161.md
page: 161
page_range: 161-162
asset: unknown
timeframe: unknown
...
phase: D
image_path: raw/book/images/page_161_fig_1.png
type: schematic
status: candidate
---
...
> the Spring to show strength.

## Kontekst

`page_161_fig_1.png` prikazuje accumulation izlaz kroz Creek, sa minor i major
Sign of Strength oznakama. Pasus vezuje SOS za lakoću bullish kretanja,
institucionalnu hitnost i reakciju koja ostaje iznad Spring low-a.

## Napomene

`page_range: 161-162` koristi stranu 162 samo da dovrši poslednju rečenicu;
primary slika je sa strane 161.
