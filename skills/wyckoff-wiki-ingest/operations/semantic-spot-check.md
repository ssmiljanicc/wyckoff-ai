...
**Kada se koristi:** za review koji ide preko strukturalnih provera — kada hoćemo da uhvatimo lošu sintezu, tihu redefiniciju već-postojećih pojmova, i površne cross-linkove koji prolaze `review_pr.py` ali nemaju semantičkog smisla.
...
- **Synthesis** — kombinacija više izvora ili generalizacija → mora biti markirano per CLAUDE.md §5 (`> **Synthesis:** ...`)
- **Hallucination** — nije ni u jednom izvoru → **FAIL**
