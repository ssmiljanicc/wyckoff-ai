---
title: "Automatic Rally (AR)"
type: event
status: active
updated: 2026-05-25
sources:
  - path: raw/book/pages/page_112.md
    note: "Chapter 16 intro — reaction confirms climax; first Change of Character (CHoCH)"
  - path: raw/book/pages/page_113.md
    note: "implications — distance of the AR is a diagnostic for accumulation vs redistribution"
  - path: raw/book/pages/page_114.md
    note: "anatomy — climactic volume at start, decreasing into the end"
  - path: raw/book/pages/page_115.md
    note: "uses — defines upper limit; identifies the genuine climax; provides market context"
  - path: raw/book/pages/page_116.md
    note: "context — drop timeframe to find a minor distribution structure that ends the AR"
  - path: raw/book/pages/page_117.md
    note: "AR definition — first signal of buyer interest after SC"
  - path: raw/book/pages/page_118.md
    note: "AR mechanics — exhaustion of offer, short covers, new buyers"
---
...
- **Exhaustion of supply** — aggressive sellers stop entering the
  market.
- **Short covering** — sellers who entered higher close their positions
  to take profit.
- **New demand** — new buyers enter on the back of the climatic event.

The combination produces "easy push up". Most of those buyers are
opportunistic — short-duration scalpers who take profits during the AR
itself, which is what ends the move.

### Anatomy — Volume and Range Profile
...
- **Small, intertwined AR** with no volume peak → market is not yet in
  balance. The subsequent [[secondary-test]] will likely come **quickly**
  and may **exceed range limits**, denoting that imbalance.

In an apparent **accumulation** structure with a weak AR, the most
honest read is to suspect **redistribution** instead. The symmetric
statement holds for distribution — a weak AR (here the
[[automatic-reaction]]) raises the probability of reaccumulation.

### Three Structural Uses
...
### Operational Implication — Drop Timeframe
...
- The AR is the first **affirmative** signal that the prior trend has
  changed. PS and SC are stop attempts; the AR is buyers actually moving
  price.
- It produces the **CHoCH** — the moment when the chart character flips
  from trending to ranging.
- Its **distance** is one of the earliest accumulation-vs-redistribution
  diagnostics available, before Phase B has even started.

## Links

- Preceding events: [[preliminary-support]], [[selling-climax]]
- Following event: [[secondary-test]]
- Mirror in distribution: [[automatic-reaction]]
- Phase: [[concepts/phase-a]]
- Structural location: [[structures/accumulation]]
- Range boundary anchor: [[structures/trading-range]]
- Fractal application: [[concepts/waves-and-fractals]]
- Sources: [[book-chapter-16]]
