---
title: "Preliminary Support / Preliminary Supply"
type: event
status: active
updated: 2026-05-25
sources:
  - path: raw/book/pages/page_093.md
    note: "Chapter 14 intro — first event of Phase A, opens stop of the previous trend"
  - path: raw/book/pages/page_094.md
    note: "appearance on the graph — single wide bar OR cluster of narrow bars with constant volume OR single bar with long wick"
  - path: raw/book/pages/page_095.md
    note: "psychology — first relevant entry of big traders; weak-hand profiles (greedy, fearful, smart-but-early)"
  - path: raw/book/pages/page_097.md
    note: "uses — stop trading the prior trend; profit-taking point"
  - path: raw/book/pages/page_098.md
    note: "Preliminary Support — multiple stop attempts before the genuine SC; potential vs confirmed PS"
  - path: raw/book/pages/page_099.md
    note: "Preliminary Support confirmed only when the four Phase A events complete; V-turn caveat"
  - path: raw/book/pages/page_100.md
    note: "Preliminary Supply — symmetric mirror; potential vs confirmed PSY"
---

# Preliminary Support / Preliminary Supply

## Summary

**Preliminary Support (PS)** is the first Wyckoff event in an accumulation
...
- A **cluster of narrower bars** with constant high volume across all of
  them.
- A **single bar with a large wick** (rejection of further extension)
  and high volume.

The book cites Tom Williams' "Master the Markets" on the diagnostic
behind this: after a prolonged move, a large trend bar with a peak of
...
- **The fearful** — long-held losing positions finally capitulating
  after seeing price move against them again.
- **The smart-but-early** — traders who correctly anticipated the turn,
  but whose timing was off and whose stops just got hit.

The same triplet appears at the [[selling-climax]] / [[buying-climax]] —
PS / PSY is a smaller-magnitude version of the same dynamic.
...
- These attempts are **potential** Preliminary Support.
- The **genuine** PS is the **penultimate** stop attempt — the last
  attempt is, by definition, the [[selling-climax]].
...
### Repeated PS as a Diagnostic Cue
...
1. **Stop trading in favor of the prior trend.** The structure has not
   ...
   is evidence enough to step aside.
2. **Excellent point to take profits** on positions held in the prior
   trend.

PS itself is **not a position-opening trigger.** It is too early — the
risk is asymmetric the wrong way around.
...
- It is the **earliest** wiki-named event in the cycle. Identifying it
  lets you anticipate the rest of Phase A: SC, AR, ST.
- It defines, in retrospect, the geography of the [[trading-range]] —
  PS sits at the lower edge of the structure once the range completes.
- A market with **many** potential PS attempts is preparing a quiet,
  exhaustion-style climax. A market with **one** PS and an immediate
  large-volume SC is the textbook climactic stop.

## Links

- Phase A events: [[selling-climax]], [[buying-climax]],
  [[automatic-rally]], [[automatic-reaction]], [[secondary-test]]
- Phase: [[concepts/phase-a]]
- Methodology principle: [[concepts/labeling-is-last-step]]
- Structural location: [[structures/accumulation]],
  [[structures/distribution]], [[structures/trading-range]]
- Sources: [[book-chapter-14]]
