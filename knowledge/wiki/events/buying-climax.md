---
title: "Buying Climax (BC)"
type: event
status: active
updated: 2026-05-25
sources:
  - path: raw/book/pages/page_101.md
    note: "Chapter 15 intro — event #2 of the methodology; BC is the distribution variant"
  - path: raw/book/pages/page_103.md
    note: "appearance — three valid representations; same as SC"
  - path: raw/book/pages/page_109.md
    note: "BC — sign of market weakness; defines upper limit of range"
  - path: raw/book/pages/page_110.md
    note: "trap dynamic — buys blocked by sells; defines resistance zone"
  - path: raw/book/pages/page_111.md
    note: "Buying Exhaustion — climax by exhaustion, no volume; preceded by repeated PSY"
---
...
The **Buying Climax (BC)** is event #2 of the methodology in a
distribution structure — the mirror of the [[selling-climax]] in
...
- A **single bar with a long upper wick** and high volume.

All three express strong entry of seller interest by large traders.
...
are "blocked with sales orders".

This is the order-flow signature: high volume, attempt to extend the
trend, but failure to sustain new highs.
...
- The BC **defines the upper boundary** of the distribution range. Once
  drawn, this boundary anchors every subsequent event in the structure.
- The decision PS-chain vs no-PS-chain answers the climactic-vs-exhaustion
  question on the top side, with implications for how much volume and
  volatility to expect through Phase B.
- A BC followed by a tepid AR (short-distance, low volume) is suspect —
  the structure may be reaccumulation disguised as distribution. See
  [[automatic-reaction]].

## Links

- Preceding event: [[preliminary-support|Preliminary Supply]]
- Following events: [[automatic-reaction]], [[secondary-test]]
- Mirror in accumulation: [[selling-climax]]
