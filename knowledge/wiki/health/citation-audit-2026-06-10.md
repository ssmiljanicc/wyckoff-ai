...
- `frontmatter_missing`: 41
- `image_only`: 1
- `inline_missing`: 98
- `quote_not_found`: 12
- `range_missing_frontmatter`: 9
- `section_boundary`: 91

## Self-Verification Controls

- PASS: `uv run skills/wyckoff-wiki-ingest/scripts/audit_citations.py --self-check` exits 1 with expected control flags.
- PASS: literal spring p.141 vs p.142 runbook quote-not-found control
- PASS: image-only raw/book/pages/page_163.md control

Full sweep also flagged these related current-base controls:
- `quote_not_found` at `knowledge/wiki/events/upthrust-after-distribution.md:L146` -> `raw/book/pages/page_141.md`; blockquote phrase not found in cited raw page: 'UTAD the shaking event the highs the structure but should'
- `image_only` at `knowledge/wiki/sources/book/book-chapter-19.md:L25` -> `raw/book/pages/page_163.md`; cited raw page contains only markdown image references and no prose
- `inline_missing` at `knowledge/wiki/sources/book/book-chapter-19.md:L25` -> `raw/book/pages/page_163.md`; frontmatter source is not cited inline on this page

## Remaining Suspicious Citations
...
- L43 `quote_not_found` `book p.149` -> `raw/book/pages/page_149.md`: blockquote phrase not found in cited raw page: 'must train ourselves anticipate the possible outcome the event and'
...
- L47 `quote_not_found` `book p.185` -> `raw/book/pages/page_185.md`: blockquote phrase not found in cited raw page: 'any case the labels are not important have think functional'
...
- L108 `frontmatter_missing` `book p.108, p.111` -> `raw/book/pages/page_108.md`: inline citation has no matching frontmatter source(s): raw/book/pages/page_108.md

### knowledge/wiki/concepts/phase-b.md

- L62 `quote_not_found` `book p.125` -> `raw/book/pages/page_125.md`: blockquote phrase not found in cited raw page: 'Once Phase has begun are going awaiting any type test'
...
- L78 `quote_not_found` `book p.185` -> `raw/book/pages/page_185.md`: blockquote phrase not found in cited raw page: 'very important aspect bear mind that can happen this stage'
...
- L32 `quote_not_found` `book p.167` -> `raw/book/pages/page_167.md`: blockquote phrase not found in cited raw page: 'Just the upward rupture movement labeled Sign Strength SOS Jump'
...
- L7 `inline_missing` `raw/book/pages/page_167.md` -> `raw/book/pages/page_167.md`: frontmatter source is not cited inline on this page
- L90 `quote_not_found` `book p.174` -> `raw/book/pages/page_174.md`: blockquote phrase not found in cited raw page: 'Many traders guided their lack understanding will buying during the'
...
- L91 `section_boundary` `book p.158–159` -> `raw/book/pages/page_158.md`: cited book page ends with uppercase heading only: 'REPRESENTATION OF LACK OF INTEREST'; check next page for supporting prose
...
- L126 `section_boundary` `book p.144–147` -> `raw/book/pages/page_144.md`: cited book page ends with uppercase heading only: 'SPRING #1 OR TERMINAL SHAKEOUT'; check next page for supporting prose
...
- L146 `quote_not_found` `book p.141` -> `raw/book/pages/page_141.md`: blockquote phrase not found in cited raw page: 'UTAD the shaking event the highs the structure but should'
...
- L66 `quote_not_found` `book p.160` -> `raw/book/pages/page_160.md`: blockquote phrase not found in cited raw page: 'the SOS fails stay above the Creek and re-enters the'
...
- L29 `quote_not_found` `book p.142` -> `raw/book/pages/page_142.md`: blockquote phrase not found in cited raw page: 'Faza PRD with the Wyckoff discipline that labels are provisional'
...
- L25 `quote_not_found` `book p.184–185` -> `raw/book/pages/page_184.md`: blockquote phrase not found in cited raw page: 'the structure taxonomy structures accumulation and siblings and the Phase'
...
- L108 `section_boundary` `p.144–147` -> `raw/book/pages/page_144.md`: cited book page ends with uppercase heading only: 'SPRING #1 OR TERMINAL SHAKEOUT'; check next page for supporting prose
...
- L79 `section_boundary` `p.158–159` -> `raw/book/pages/page_158.md`: cited book page ends with uppercase heading only: 'REPRESENTATION OF LACK OF INTEREST'; check next page for supporting prose
...
- L83 `section_boundary` `p.205–206` -> `raw/book/pages/page_205.md`: cited book page ends with uppercase heading only: 'ENTRY WITH MINOR STRUCTURES'; check next page for supporting prose
...
- L133 `quote_not_found` `book p.40–41` -> `raw/book/pages/page_040.md`: blockquote phrase not found in cited raw page: 'The objective the price visit this liquidity zone but the'
...
- L82 `quote_not_found` `book p.148` -> `raw/book/pages/page_148.md`: blockquote phrase not found in cited raw page: 'Ordinary Shakeout defined strong bearish push without extensive prior preparation'
