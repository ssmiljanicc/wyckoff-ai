---
title: "The Significant Bar"
type: concept
status: active
updated: 2026-05-25
sources:
  - path: raw/book/pages/page_208.md
    note: "primary definition — chapter 27, decision-making"
  - path: raw/book/pages/page_209.md
    note: "the four characteristics of a significant bar"
  - path: raw/book/pages/page_210.md
    note: "synthesizing two normal bars into one significant bar"
---
...
2. **Volume** — operated volume proportional to that wider range (i.e.
   higher than prior bars).
3. **Close** — in the middle-to-end of the bar's range, in the direction
   of the current movement. Bullish significant bar closes in the upper
   half; bearish in the lower half.
4. **Commitment** — the close commits through a relevant level. Bullish
   close above a prior resistance; bearish close below a prior support.
...
### Why Volume Must Be Proportional

A wide-range bar without proportional volume is precisely the divergence
case from [[effort-and-result]]: the level was undefended, the move is
unsupported, and continuation is not assured. The four characteristics are
designed to filter that case out before reading intent.
...
- Common at: SOS / SOW breakouts, climax events
  ([[events/selling-climax]], [[events/buying-climax]]), the test bar of
  a [[events/spring]] or UTAD when the reverse is in progress.

## Links

- Parent law: [[effort-and-result]]
- Pairs with: [[reversal-of-movement]]
- Applied: trade location at [[concepts/phase-c]],
  [[concepts/phase-d]]
