---
title: "The Three Fundamental Laws"
type: concept
status: active
updated: 2026-05-25
sources:
  - path: raw/book/pages/page_036.md
    note: "Part 2 intro — names the three laws as Wyckoff's basic foundations"
  - path: raw/book/pages/page_046.md
    note: "Part 3 cover — 'The Three Fundamental Laws'"
  - path: raw/book/pages/page_047.md
    note: "Chapter 7 — supply and demand"
  - path: raw/book/pages/page_054.md
    note: "Chapter 8 — cause and effect"
  - path: raw/book/pages/page_061.md
    note: "Chapter 9 — effort and result"
---
...
When labeling becomes uncertain, return to the laws: ask which force is
aggressive, whether a cause has been built, and whether effort is producing
result.
...
that absorption. A clean Wyckoff read names all three at once.

## Why This Page Exists

The three laws are the canonical entry point to the methodology. This page
exists so other wiki pages can link to a single anchor when they say "by the
law of cause and effect..." without restating it. The detailed mechanics
live on the three sub-pages.

## Links

- Sub-laws: [[supply-and-demand]], [[cause-and-effect]], [[effort-and-result]]
- Application: [[market-cycle]], [[path-of-least-resistance]],
  [[random-vs-purposeful-range]], [[trading-range]]
- Source summaries: [[book-chapter-07]], [[book-chapter-08]],
  [[book-chapter-09]]
