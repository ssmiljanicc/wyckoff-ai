---
title: "Book Chapter 21 — Phase A: Stopping the Previous Trend"
type: source-summary
status: active
updated: 2026-05-25
sources:
  - path: raw/book/pages/page_178.md
    note: "Part 6 intro — phase analysis structures the absorption/distribution process; five phases"
  - path: raw/book/pages/page_179.md
    note: "five phases enumerated: A stop, B cause, C test, D trend within range, E trend out of range"
  - path: raw/book/pages/page_180.md
    note: "Phase A intro — function (stop the previous trend); four events"
  - path: raw/book/pages/page_181.md
    note: "Phase A narrative — first signs of true interest, climax, reaction, test"
---

# Book Chapter 21 — Phase A: Stopping the Previous Trend

## What This Chapter Is

The first **phase** chapter, opening **Part 6** of the book. Defines
Phase A and lists its four events: PS / PSY, SC / BC, AR, ST.

Pages: `raw/book/pages/page_178.md`–`page_181.md` (covers the
Part-6 intro at p.178–179 plus Chapter 21 proper).

## Why It Matters

Short and direct. Phase A is short structurally (4 events in
...
- [[concepts/phase-a]] — primary derivative

(Phase A event pages were primarily sourced from chapters 14–17;
this chapter contributes the phase-level framing and ordering.)

## Related Chapters

- [[book-chapter-14]] (PS — first Phase A event)
- [[book-chapter-15]] (Climax — second event)
- [[book-chapter-16]] (Reaction — third event)
- [[book-chapter-17]] (Test — fourth event)
- [[book-chapter-22]] (Phase B — the next phase)
- [[book-chapter-02]] (Market Cycle — context for where Phase A sits
  in the cycle)
