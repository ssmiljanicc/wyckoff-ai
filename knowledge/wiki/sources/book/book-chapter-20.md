---
title: "Book Chapter 20 — Event #7: Confirmation"
type: source-summary
status: active
updated: 2026-05-25
sources:
  - path: raw/book/pages/page_167.md
    note: "intro — confirmation is the test of the breakout; LPS/BUEC, LPSY/FTI naming"
  - path: raw/book/pages/page_168.md
    note: "FTI definition; ice as support analog to creek; confirmation criteria"
  - path: raw/book/pages/page_169.md
    note: "natural action of a trend — impulsive then corrective; warning at high-volume test"
  ...
  - path: raw/book/pages/page_171.md
    note: "operational opportunity — Wyckoff's preferred entry; structural anchor for stop"
  - path: raw/book/pages/page_172.md
    note: "entry triggers — SOS bar / SOW bar; order types; stop placement"
  - path: raw/book/pages/page_173.md
    note: "quantification — objectifying triggers; backtest considerations; LPS section starts"
  ...
  - path: raw/book/pages/page_175.md
    note: "LPS coincides with PS price; LPS-buy / not-SOS-buy discipline"
  - path: raw/book/pages/page_176.md
    note: "LPSY definition; three types by location, mirror of LPS"
  - path: raw/book/pages/page_177.md
    note: "LPSY character — narrow ranges, low volume; high-volume warning; PSY coincidence"
---

# Book Chapter 20 — Event #7: Confirmation

## What This Chapter Is

Defines the confirmation event — **Last Point of Support (LPS) / Back
Up to the Edge of the Creek (BUEC)** in accumulation and **Last Point
of Supply (LPSY) / Fall Through The Ice (FTI)** in distribution. This
is event #7 of the methodology — the confirmation test that validates
the Phase D breakout.

Pages: `raw/book/pages/page_167.md`–`page_177.md`.
...
- [[events/last-point-of-support]] — primary derivative
- [[events/last-point-of-supply]] — primary derivative
- [[events/back-up-to-the-edge-of-the-creek]] — secondary derivative
  (geographic name for out-of-range LPS)
- [[events/fall-through-the-ice]] — secondary derivative (geographic
  name for out-of-range LPSY)
- [[concepts/phase-d]] — chapter is one of Phase D's two source
  chapters
- [[concepts/action-test-confirmation]] — confirmation criteria
- [[events/failed-signal]] — high-volume retest as failed-signal cue
- [[concepts/significant-bar]] — entry trigger cross-reference

## Related Chapters

- [[book-chapter-19]] (Breakout — the event being confirmed)
- [[book-chapter-24]] (Phase D — phase confirmation completes)
- [[book-chapter-25]] (Phase E — phase that begins after confirmation)
