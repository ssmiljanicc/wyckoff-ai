---
title: "Book Chapter 16 — Event #3: Reaction"
type: source-summary
status: active
updated: 2026-05-25
sources:
  - path: raw/book/pages/page_112.md
    note: "intro — reaction confirms climax; first CHoCh of the structure"
  - path: raw/book/pages/page_113.md
    note: "implications — AR distance as diagnostic; weak AR = redistribution / reaccumulation suspect"
  - path: raw/book/pages/page_114.md
    note: "anatomy — climactic volume at start, decreasing into the end; narrowing ranges"
  - path: raw/book/pages/page_115.md
    note: "three structural uses: defines range limit, identifies the climax, provides context"
  - path: raw/book/pages/page_116.md
    note: "drop-timeframe operational implication; opportunity to scalp"
  - path: raw/book/pages/page_117.md
    note: "Automatic Rally — first signal of buyer interest after SC"
  - path: raw/book/pages/page_118.md
    note: "AR mechanics — exhaustion of supply, short covers, new buyers"
  - path: raw/book/pages/page_119.md
    note: "Automatic Reaction — first sign of selling interest after BC"
  - path: raw/book/pages/page_120.md
    note: "AR mechanics on the distribution side — symmetric"
---

# Book Chapter 16 — Event #3: Reaction

## What This Chapter Is

Introduces the **Automatic Rally (AR)** for accumulation and the
**Automatic Reaction (AR)** for distribution — event #3 of Phase A,
the first counter-move with conviction after the climax.

Pages: `raw/book/pages/page_112.md`–`page_120.md`.
...
- [[events/automatic-rally]] — primary derivative
- [[events/automatic-reaction]] — primary derivative
- [[concepts/phase-a]] — chapter is one of Phase A's four source
  chapters

## Related Chapters

- [[book-chapter-15]] (Climax — the preceding event)
- [[book-chapter-17]] (Test — the next event)
- [[book-chapter-11]], [[book-chapter-13]] (Reaccumulation /
  Redistribution — disambiguation cases that the AR distance signals)
