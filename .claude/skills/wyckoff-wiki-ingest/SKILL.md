...
# Wyckoff Wiki Ingest (Claude wrapper)

Run the canonical runbook:

[`runbooks/wyckoff-wiki-ingest.md`](../../../runbooks/wyckoff-wiki-ingest.md)

Use the Claude Code adapter section in that runbook.

Treat `$ARGUMENTS` as the runbook input — tipično batch broj (1–9), PR broj za review, ili `spot-check <PR>` za semantic review.

## Quick reference

- **Pokretanje novog batch-a:** [`skills/wyckoff-wiki-ingest/operations/ingest-batch.md`](../../../skills/wyckoff-wiki-ingest/operations/ingest-batch.md)
- **Mehanički PR review:** [`skills/wyckoff-wiki-ingest/operations/review-pr.md`](../../../skills/wyckoff-wiki-ingest/operations/review-pr.md)
- **Semantic spot-check:** [`skills/wyckoff-wiki-ingest/operations/semantic-spot-check.md`](../../../skills/wyckoff-wiki-ingest/operations/semantic-spot-check.md)

## Disciplinske invariante (skraćeno — pun tekst u runbook-u)

- **Path depth:** vidi runbook §2 — citation linkovi razrešavaju iz stvarne dubine stranice
