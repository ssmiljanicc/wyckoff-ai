...
class AnalysisJournalStore:
        ...
        *,
        ...
        record: AnalysisRecord = {
            ...
            "forecast": {
                ...
                "trigger": str(forecast["trigger"]),
                "invalidation": str(forecast["invalidation"]),
    ...
    def _load_records_and_reviews(
        ...
        *,
        ...
        reviews = self._load_reviews(sorted(self.base_dir.glob("*.jsonl")))
        ...
        for path in candidate_files:
            ...
            with path.open(encoding="utf-8") as f:
                for line in f:
                    ...
                    if isinstance(analysis_id, str) and isinstance(review, dict):
                        self._store_latest_review(reviews, analysis_id, review)
        return reviews
